...
public class WfstpdemoTestContainer extends TestContainer {

    public WfstpdemoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/wfstpdemo/app.properties",
    ...
    public static class Common extends WfstpdemoTestContainer {

        public static final WfstpdemoTestContainer.Common INSTANCE = new WfstpdemoTestContainer.Common();
