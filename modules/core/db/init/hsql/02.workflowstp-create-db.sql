...
alter table WFSTP_STAGE_ACTORS_LINK add constraint FK_WFSSTAACT_ON_STAGE foreign key (STAGE_ID) references WFSTP_STAGE(ID)^
alter table WFSTP_STAGE_ACTORS_LINK add constraint FK_WFSSTAACT_ON_USER foreign key (ACTOR_ID) references SEC_USER(ID)^
-- end WFSTP_STAGE_ACTORS_LINK
-- begin WFSTP_STAGE_VIEWERS_ROLES_LINK
alter table WFSTP_STAGE_VIEWERS_ROLES_LINK add constraint FK_WFSSTAVIEROL_ON_STAGE foreign key (STAGE_ID) references WFSTP_STAGE(ID)^
alter table WFSTP_STAGE_VIEWERS_ROLES_LINK add constraint FK_WFSSTAVIEROL_ON_ROLE foreign key (VIEWER_ROLE_ID) references SEC_ROLE(ID)^
-- end WFSTP_STAGE_VIEWERS_ROLES_LINK
-- begin WFSTP_STAGE_ACTORS_ROLES_LINK
alter table WFSTP_STAGE_ACTORS_ROLES_LINK add constraint FK_WFSSTAACTROL_ON_STAGE foreign key (STAGE_ID) references WFSTP_STAGE(ID)^
alter table WFSTP_STAGE_ACTORS_ROLES_LINK add constraint FK_WFSSTAACTROL_ON_ROLE foreign key (ACTOR_ROLE_ID) references SEC_ROLE(ID)^
-- end WFSTP_STAGE_ACTORS_ROLES_LINK
-- begin WFSTP_STAGE_VIEWERS_LINK
alter table WFSTP_STAGE_VIEWERS_LINK add constraint FK_WFSSTAVIE_ON_STAGE foreign key (STAGE_ID) references WFSTP_STAGE(ID)^
alter table WFSTP_STAGE_VIEWERS_LINK add constraint FK_WFSSTAVIE_ON_USER foreign key (VIEWER_ID) references SEC_USER(ID)^
